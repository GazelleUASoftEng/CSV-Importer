...
$table = "product_test"
$hostname = "localhost"
$csvlocation = "#{Dir.home}/Documents/software_engineering/"
...
CSV.foreach($csvlocation+"products.csv", quote_char: "|", :headers => true) do |product|
  ...
  begin
    ...
    puts $!
    CSV.open($csvlocation+"product_import_error_log.csv", "a") do |errorRow|
      errorRow << product
    end
  end
end